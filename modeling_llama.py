...
class LlamaRotaryEmbedding(nn.Module):   ###enhance attention mechanism of the model
    def __init__(
        self,
        dim=None,
...
class LlamaMLP(nn.Module):           ###implement MLP, used to deal with middle layers of the model
